...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        txtCategori =(TextView) findViewById(R.id.product_category);
        InputProductDescription = (EditText) findViewById(R.id.product_description);
        InputProductDescription.setMovementMethod(new ScrollingMovementMethod());
        InputProductPrice = (EditText) findViewById(R.id.product_price);
        txtCategori.setText(CategoryName);
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this, "Lấy link ảnh thành công", Toast.LENGTH_SHORT).show();
    ...
    {
        Long miu =  Calendar.getInstance().getTimeInMillis();
        String timeStamp= String.valueOf(miu);
        HashMap<String, Object> productMap = new HashMap<>();
        productMap.put("pid", productRandomKey);
        productMap.put("date", saveCurrentDate);
        productMap.put("time", "-"+timeStamp);
