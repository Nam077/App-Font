...
public class SettingActivity extends AppCompatActivity {
    ...
    private EditText fullNameEditText, userPhoneEditText, addressEditText, sdtEditText;
    private TextView profileChangeTextBtn, closeTextBtn, saveTextButton, UserView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserView =  findViewById(R.id.setting_username);
        sdtEditText = findViewById(R.id.settings_sdt);
    ...
    private void updateOnlyUserInfo() {
        ...
        userMap.put("sdt", sdtEditText.getText().toString());
    ...
    private void userInfoSaved() {
        ...
        if (TextUtils.isEmpty(fullNameEditText.getText().toString())) {
            ...
            Toast.makeText(this, "Name is mandatory.", Toast.LENGTH_SHORT).show();
        } else if (!userPhoneEditText.getText().toString().matches(emailPattern)) {
            userPhoneEditText.setError("Nhập email dạng name@example.com");
            return;
        } else {
            uploadImage();
        }
    ...
    private void uploadImage() {
        ...
        progressDialog.setTitle("Cập Nhật Thông Tin Người Dùng");
        progressDialog.setMessage("Vui lòng chờ đang tiến hành cập nhật");
        ...
        UsersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.child("image").exists()){
                        ...
                        Glide.with(SettingActivity.this).load(image).into(profileImageView);
                    }
                    ...
                    UserView.setText("Tài Khoản: " + username);
